...
?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                       ...
                       <div class="panel panel-primary">
							<div class="panel-heading">
								<div class="row">
									...
									<?php
										//$query1 = "SELECT user_id FROM users WHERE username = '{$_SESSION['username']}'";
										//$id = mysqli_query ($connection, $query1);
										...
										$query = "SELECT * FROM posts WHERE post_status = 'Posted' AND post_author = '{$_SESSION['username']}'";
                       ...
                       <div class="panel panel-green">
							<div class="panel-heading">
								<div class="row">
									...
									<?php
										$query = "SELECT * FROM comments WHERE comment_status = 'Approve' AND comment_author = '{$_SESSION['username']}'";
										$_comment = mysqli_query ($connection, $query);
										$num_comment = mysqli_num_rows($_comment);
			...
			<div class="col-sm-12">
			<?php
				$query = "SELECT * FROM posts WHERE post_status = 'Pending' AND post_author = '{$_SESSION['username']}'";
				$pending_post = mysqli_query ($connection, $query);
				$count_pending_post = mysqli_num_rows($pending_post);
				
				$query1 = "SELECT * FROM comments WHERE comment_status = 'Unapprove' AND comment_author = '{$_SESSION['username']}'";
