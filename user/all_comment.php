    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div id="comment-card">
					<?php 		 
						$query1 = "SELECT * FROM comments WHERE comment_author = '{$_SESSION['username']}' ORDER BY comment_id DESC";
					...
					<div class="col-sm-4 col-md-3">
						<div class="panel panel-primary">
							...
							<div class="panel-footer">
								<div class="row">
									<div class="link"><a href="all_comment.php?com_id=<?php echo $comment_id;?>">Approve</a></div>
									<div class="link"><a href='all_comment.php?comment_id=<?php echo $comment_id; ?>'>Unapprove</a></div>
								</div>
						   </div>
							<div class="panel-footer text-center">
								<a href='all_comment.php?delete=<?php echo $comment_id ?>'>Delete</a>
						   </div>
						</div>
					</div>
